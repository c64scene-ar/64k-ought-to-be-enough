...
scroll_text:
        ...
        db '  '
        db 'AND SECONDLY, EVERYTIME THE VIDEO CARD ACCESS THE RAM, IT ADDS SOME WAIT-STATES, '
        ...
        db 'LEFT TO USE FOR EVERYTHING ELSE: INTERRUPT VECTOR TABLE, BIOS VARIABLES, '
        db ' AND DOS. '
